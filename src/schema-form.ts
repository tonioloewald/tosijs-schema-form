...
export const schemaForm = makeComponent('schema-form', (tag, { Component, elements }): any => {
  ...
  return {
    ...
    styleSpec: {
      ...
      '.schema-field label': {
        display: 'block',
        marginBottom: 'calc(var(--spacing, 8px) * 0.5)',
        fontWeight: '500',
      },
      '.schema-field input, .schema-field select, .schema-field textarea': {
        width: '100%',
        padding: 'calc(var(--spacing, 8px) * 0.75) var(--spacing, 8px)',
        border: '1px solid var(--border-color, #ccc)',
        borderRadius: 'calc(var(--spacing, 8px) * 0.5)',
        fontSize: 'inherit',
        fontFamily: 'inherit',
        color: 'inherit',
        background: 'var(--input-bg, var(--background, #fcfcfc))',
        boxSizing: 'border-box',
      },
      '.schema-field input:focus, .schema-field select:focus, .schema-field textarea:focus': {
        outline: 'none',
        borderColor: 'var(--focus-color, var(--brand-color, #0066cc))',
        boxShadow: '0 0 0 2px var(--focus-color, var(--brand-color, #0066cc))40',
      },
      ...
      '.description': {
        fontSize: 'calc(var(--font-size, 16px) * 0.85)',
        opacity: '0.7',
        marginBottom: 'calc(var(--spacing, 8px) * 0.5)',
      },
      '.required': {
      ...
      '.schema-object legend, .schema-array legend': {
        fontWeight: '600',
        padding: '0 calc(var(--spacing, 8px) * 0.5)',
      },
      '.schema-array-items': {
        display: 'flex',
      ...
      '.schema-array-item': {
        position: 'relative',
        paddingRight: 'calc(var(--spacing, 8px) * 2.5)',
        paddingLeft: 'calc(var(--spacing, 8px) * 0.5)',
        borderLeft: '2px solid var(--brand-color, #0066cc)',
      },
      '.schema-array-remove': {
        position: 'absolute',
        top: '0',
      ...
      '.schema-array-add': {
        marginTop: 'calc(var(--spacing, 8px) * 0.5)',
        padding: 'calc(var(--spacing, 8px) * 0.5) var(--spacing, 8px)',
        border: '1px dashed var(--brand-color, #0066cc)',
      ...
      '.schema-array-add:hover': {
        background: 'var(--brand-color, #0066cc)10',
      },
      '.array-constraints': {
        fontSize: 'calc(var(--font-size, 16px) * 0.85)',
        opacity: '0.7',
        marginTop: 'calc(var(--spacing, 8px) * 0.25)',
      },
    },
  }
})
